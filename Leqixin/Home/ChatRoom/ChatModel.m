...
//    NSString *URLStr = @"http://img0.bdstatic.com/img/image/shouye/xinshouye/mingxing16.jpg";
    ...
    NSString *URLStr = tempAppDelegate.userModel.headimg;
    [dataDic setObject:@(UUMessageFromMe) forKey:@"from"];
    [dataDic setObject:[[NSDate date] description] forKey:@"strTime"];
    [dataDic setObject:tempAppDelegate.userModel.truename forKey:@"strName"];
...
- (NSArray *)addMsgItems:(NSMutableArray *)arr
{
...
//        NSDictionary *dataDic = [self getDic];
        NSDictionary *receiveDic = arr[i];
        NSMutableDictionary *dic = [NSMutableDictionary dictionary];
        [dic setValue:@"访客" forKey:@"strName"];
        [dic setValue:receiveDic[@"vistorId"] forKey:@"strId"];
...
//            randomNum = UUMessageTypeText;
            [dic setValue:receiveDic[@"content"] forKey:@"strContent"];
//        }
        UUMessageFrame *messageFrame = [[UUMessageFrame alloc]init];
        UUMessage *message = [[UUMessage alloc] init];
