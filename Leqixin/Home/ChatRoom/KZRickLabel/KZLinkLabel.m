...
//    [self addGestureRecognizer:longPressGesture];
    UITapGestureRecognizer *tapGes = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(longPressLabel:)];
...
- (IBAction)longPressLabel:(UITapGestureRecognizer *)recognizer
{
