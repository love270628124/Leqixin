...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:self.doneAssets,@"assets", nil];

    [[NSNotificationCenter defaultCenter] postNotificationName:PICKER_REFRESH_DONE object:nil userInfo:dic];
